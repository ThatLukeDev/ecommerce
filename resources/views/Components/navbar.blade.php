...
<nav class="bg-gray-800 text-white p-5 top-0 fixed w-full inline-flex">
    <span class="peer max-md:has-[:hover]:w-full order-1000 group md:flex-auto inline-flex items-center bg-gray-700 p-2 mr-2 md:mr-10 rounded-full">
    ...
    <a href="/account" class="order-1001 inline-flex justify-end items-center max-md:flex-auto">
        <img class="rounded-full self-center size-[2em]" src="{{ Auth::check() ? '/avatar.jpg' : '/noaccount.svg' }}">
    </a>
</nav>