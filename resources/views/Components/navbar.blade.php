...
<nav class="bg-gray-800 text-white p-5 top-0 fixed w-full inline-flex z-1">
    <span id="mainsearch" class="peer max-md:[.pressed]:w-full order-1000 group md:flex-auto inline-flex items-center bg-gray-700 p-2 mr-2 md:mr-10 rounded-full">
