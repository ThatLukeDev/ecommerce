...
<nav class="bg-gray-800 text-white p-5 top-0 fixed w-full inline-flex">
    ...
    <span class="md:flex-auto inline-flex items-center bg-gray-700 p-2 mr-10 rounded-full">
        ...
        <form action="{{ request()->path() }}" method="get" class="flex-auto">
            ...
            <input type="text" name="query" value="{{ request('query') }}" class="w-full hidden md:inline outline-none">
        </form>
    </span>
</nav>