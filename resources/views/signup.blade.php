...
<html>
    ...
    <body class="bg-gray-50">
        ...
        <form class="mt-50 m-10" action="{{ request()->path() }}" method="post">
            ...
            <div class="inline-flex justify-center w-full"><input type="password" name="password2" placeholder="Confirm password" class="p-2 my-2 w-100 bg-gray-200 rounded-t-xl rounded-b-lg outline-none border-b-[0.5vh] border-gray-400 focus:border-indigo-400 default:text-gray-600"></div>
            ...
            <div class="inline-flex justify-center w-full"><p class="{{ isset($error) ? '' : 'hidden' }} text-red-400 mb-5">{{ isset($error) ? $error : '' }}</p></div>
